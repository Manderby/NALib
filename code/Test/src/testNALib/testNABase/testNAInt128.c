...
void testNAInt128Make(){
  ...
  NAu128 u4 = naMakeu128WithBinary(0x11223344, 0xffeeddcc, 0x98765432, 0x12345678);
  ...
  naTest(equalu128(u4, 0x11223344, 0xffeeddcc, 0x98765432, 0x12345678));
}
