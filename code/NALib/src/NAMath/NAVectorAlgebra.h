...
typedef int32  NAVec1i32[1];
typedef int32  NAVec2i32[2];
typedef int32  NAVec3i32[3];
typedef int32  NAVec4i32[4];
typedef int64  NAVec1i64[1];
typedef int64  NAVec2i64[2];
typedef int64  NAVec3i64[3];
typedef int64  NAVec4i64[4];
...
NA_IAPI void naFillV1i32(int32*  d, int32  a0);
NA_IAPI void naFillV2i32(int32*  d, int32  a0, int32  a1);
NA_IAPI void naFillV3i32(int32*  d, int32  a0, int32  a1, int32  a2);
NA_IAPI void naFillV4i32(int32*  d, int32  a0, int32  a1, int32  a2, int32  a3);
NA_IAPI void naFillV1i64(int64*  d, int64 a0);
NA_IAPI void naFillV2i64(int64*  d, int64  a0, int64  a1);
NA_IAPI void naFillV3i64(int64*  d, int64  a0, int64  a1, int64  a2);
NA_IAPI void naFillV4i64(int64*  d, int64  a0, int64  a1, int64  a2, int64  a3);
...
NA_IAPI void naZeroV1i32(int32*  d);
NA_IAPI void naZeroV2i32(int32*  d);
NA_IAPI void naZeroV3i32(int32*  d);
NA_IAPI void naZeroV4i32(int32*  d);
NA_IAPI void naZeroV1i64(int64*  d);
NA_IAPI void naZeroV2i64(int64*  d);
NA_IAPI void naZeroV3i64(int64*  d);
NA_IAPI void naZeroV4i64(int64*  d);
