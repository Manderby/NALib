...
NA_HHDEF void na_BlockUIElementNotifications(NA_UIElement* elem){
  #ifndef NDEBUG
...
NA_HHDEF void na_AllowUIElementNotifications(NA_UIElement* elem){
  #ifndef NDEBUG
...
NA_HHDEF NABool na_AreUIElementNotificationsAllowed(NA_UIElement* elem){
